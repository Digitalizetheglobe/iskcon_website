...
export default function termsConditionsPage() {
  return (
    <div className=" w-full lg:max-w-7xl mx-auto px-4 py-10 text-gray-800 space-y-6">
      ...
      <h2 className="text-lg font-semibold mt-6">ONLINE STORE TERMS</h2>
      <p className="text-base text-justify">
      ...
      <h2 className="text-lg font-semibold mt-6">GENERAL CONDITIONS</h2>
      <p className="text-base text-justify">
      ...
      <h2 className="text-lg font-semibold mt-6">PRODUCTS OR SERVICES</h2>
      <p className="text-base text-justify">
      ...
      <h2 className="text-lg font-semibold mt-6">OPTIONAL TOOLS</h2>
      <p className="text-base text-justify">
      ...
      <h2 className="text-lg font-semibold mt-6">THIRD-PARTY LINKS</h2>
      <p className="text-base text-justify ">
      ...
      <h2 className="text-lg font-semibold mt-6">PROHIBITED USES</h2>
      <p className="text-base text-justify ">
      ...
      <h2 className="text-lg font-semibold mt-6">SEVERABILITY</h2>
      <p className="text-base text-justify ">
      ...
      <h2 className="text-lg font-semibold mt-6">ENTIRE AGREEMENT</h2>
      <p className="text-base text-justify ">
      ...
      <p className="text-base text-justify ">
        ...
        laws of India and jurisdiction of Hyderabad, Telangana
      </p>
      <h2 className="text-lg font-semibold mt-6">
