    ...
    <>
      ...
      {isMobile ? (
              ...
              <div className="px-2 mt-10 ">
                ...
                <div className="flex flex-col gap-3">
                  {missionContent.points.map((point, index) => (
                    <div
                      key={index}
                      className="flex items-center w-[320px] bg-white px-4 py-2 rounded-full shadow-lg text-sm font-bold "
                    >
                ...
                <div className="px-2 mt-10 ">
                  ...
                  <div className="flex flex-col gap-3">
                    {visionContent.points.map((point, index) => (
                      <div
                        key={index}
                        className="flex flex-row-reverse justify-start items-center w-[320px] bg-white px-4 py-2 rounded-full shadow-lg text-sm font-bold gap-2"
                      >
                        <span className="mr-2">✦</span>
                        {point}
                      </div>
                  ...
                  <div className="flex flex-col justify-start items-start">
                    ...
                    <div className="text-center mb-16">
                      ...
                      <p className="text- text-gray-600 max-w-2xl mx-auto leading-relaxed">
                        Because every child deserves a chance to learn, grow,
                        and thrive — no matter where they come from.
                      </p>
                    </div>
                          ...
                          <div className="flex-1 max-w-lg">
                            ...
                            <div className="space-y-4 text-gray-600 leading-relaxed">
                              <p>
                                ...
                                integrated curriculum of Hare Krishna Vidya,
                                which puts value education and life skills into
                                the curriculum along with school subjects.
                              </p>
                          ...
                          <div className="flex-1 max-w-lg">
                            ...
                            <div className="text-gray-600 leading-relaxed">
                              <p>
                                ...
                                organization on a mission to empower every
                                single child from rural areas, through free
                                education.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex-1 max-w-lg">
                            ...
                            <div className="text-gray-600 leading-relaxed">
                              <p>
                                ...
                                doubts will be clarified through teacher and
                                peer learning.
                              </p>
                            </div>
                          </div>
        ...
        <div>
          ...
          <section className="flex items-center justify-center max-w-6xl mx-auto mt-10  bg-white">
            <div className="grid grid-cols-6 grid-rows-5 gap-4 max-w-5xl mx-auto">
