...
{isMobile ? (
  ...
  <section
    className="relative bg-cover bg-center text-white w-full h-[90vh] md:h-[700px] max-w-7xl mx-auto rounded-xl overflow-hidden bg-black opacity-100"
...
<div className=" hidden md:block w-full relative overflow-hidden p-4 md:p-7 items-center justify-center min-h-screen">
  {/* Desktop grid layout - hidden on mobile */}
  <div className="hidden md:grid grid-cols-7 grid-rows-6 gap-3 h-screen max-w-6xl mx-auto">
    {/* Top Description Box */}
    <div
