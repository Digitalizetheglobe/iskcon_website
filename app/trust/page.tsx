  ...
  return (
    <div className="bg-white text-[#1a1a1a]">
      <main className="px-6 md:px-20 py-12">
        <h1 className="text-4xl font-bold text-center text-orange-600 mb-6">Our Associated Trusts</h1>
...
With a goal to bring in 3 million children under our wings and provide them with nutritious meals under the mid-day meal programme by 2025, our nonprofit organisation is open to collaborations and charity donations to realise our goals.
          ...
          <div className="p-2 mt-2">
            ...
            {activeModal === 'trust1' && (
              <Modal onClose={handleClose} images={['/images/mid.jpg', '/images/mid2.jpg', '/images/mid3.jpg', '/images/mid4.jpg']} />
            )}
          </div>
        </section>
        ...
        <section className="mb-10 mt-4">
          <Image src="/images/imggg.png" alt="Hare Krishna Charities" width={180} height={50} />
          <p className="mt-4 text-sm leading-6">
...
With 4 Hi-Tech Kitchens (Warangal, Narsingi-Hyderabad, Mahbubnagar and Srikakulam) across Telangana and Andhra Pradesh, we ensure that hot and nutritious meals reach the needy who await a square meal of the day and and give them a ray of hope of fulfilment. Our Technology enabled kitchens have the capacity to cook meals ranging from 20,000 to 50,000 per day. All our kitchens endeavor to utilize the latest technology to continuously improve the quality and nutrition levels of the meals and to implement environment friendly cooking by reducing the wastages.
          ...
          <div className="p-2 mt-2">
            ...
            {activeModal === 'trust2' && (
              <Modal onClose={handleClose} images={['/images/ch2.jpg', '/images/ch.jpg', '/images/ch3.jpg', '/images/ch4.jpg']} />
            )}
          </div>
        </section>
        ...
        {/* Section 3 */}
        <section className="mb-10 mt-4">
          <Image src="/images/logo.png" alt="Hare Krishna Movement" width={180} height={50} />
          <p className="mt-4 text-sm leading-6">
          ...
          <div className="p-2 mt-2">
            ...
            {activeModal === 'trust3' && (
              <Modal onClose={handleClose} images={['/images/mov3.jpg', '/images/mo2.jpg', '/images/mov2.jpg', '/images/mo.jpg']} />
            )}
          </div>
        </section>
      </main>
    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-70 flex justify-center items-center">
      ...
      <div className="grid grid-cols-2 grid-rows-2 gap-4 p-4 rounded-lg shadow-lg transform scale-90 animate-zoomIn transition-all duration-300">
        {images.map((src, index) => (
          <div key={index} className="relative w-40 h-40 sm:w-52 sm:h-52 overflow-hidden group">
            <Image
              src={src}
              alt={`Image ${index + 1}`}
              fill
...
function Divider() {
  return (
    <div className="w-full h-4 relative -mt-4">
      <Image src="/images/divider.png" alt="Divider" fill className="object-contain" />
    </div>
  );
}
